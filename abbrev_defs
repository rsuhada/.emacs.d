...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ...
    ("aphys" "astrophysics" nil 0)
    ("asap" "as soon as possible" nil 0)
    ("atm" "at the moment" nil 6)
    ("bbn" "BBN" nil 1)
    ("bc" "because" nil 17)
    ("bg" "background" nil 23)
    ...
    ("freq" "frequency" nil 1)
    ("freqs" "frequencies" nil 0)
    ("funct" "function" nil 2)
    ("functs" "functions" nil 0)
    ("gal" "galaxy" nil 10)
    ("gals" "galaxies" nil 14)
 ...
 Robert" nil 4)
    ("sig1" "Cheers,
 Robert" nil 3)
    ("sim" "simulation" nil 3)
    ("sims" "simulations" nil 22)
    ("smbh" "SMBH" nil 5)
    ("smt" "sometime" nil 0)
    ("spt" "SPT" nil 13)
    ("src" "source" nil 8)
