...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ...
    ("aphys" "astrophysics" nil 0)
    ("asap" "as soon as possible" nil 0)
    ("atm" "at the moment" nil 18)
    ("bbn" "BBN" nil 1)
    ("bc" "because" nil 37)
    ("bcg" "BCG" nil 1)
    ("bg" "background" nil 52)
    ("bgs" "backgrounds" nil 2)
    ("bh" "BH" nil 34)
 ...
 Robert" nil 4)
    ("sig1" "Cheers,
 Robert" nil 3)
    ("sim" "simulation" nil 9)
    ("sims" "simulations" nil 44)
    ("smbh" "SMBH" nil 5)
    ("smt" "sometime" nil 0)
    ("spt" "SPT" nil 53)
    ("src" "source" nil 36)
    ...
    ("w" "with" nil 252)
    ("wi" "within" nil 7)
    ("wl" "weak lensing" nil 26)
    ("wmap" "WMAP" nil 1)
    ("wo" "without" nil 18)
    ("wrt" "with respect to" nil 14)
    ("xbcs" "XBCS" nil 18)
    ("xmm" "XMM-Newton" nil 51)
    ("xmm-bcs" "XMM-BCS" nil 0)
