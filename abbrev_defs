...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ...
    ("aphys" "astrophysics" nil 0)
    ("asap" "as soon as possible" nil 0)
    ("atm" "at the moment" nil 15)
    ("bbn" "BBN" nil 1)
    ("bc" "because" nil 30)
    ("bg" "background" nil 36)
 ...
 Robert" nil 3)
    ...
    ("wmap" "WMAP" nil 1)
    ("wo" "without" nil 15)
    ("wrt" "with respect to" nil 10)
    ("xbcs" "XBCS" nil 3)
    ("xmm" "XMM-Newton" nil 42)
    ("xmm-bcs" "XMM-BCS" nil 0)
