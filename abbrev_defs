...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ...
    ("chan" "Chandra" nil 13)
    ("cmb" "CMB" nil 6)
    ("coord" "coordinate" nil 1)
    ("coords" "coordinates" nil 5)
 ...
 Robert" nil 4)
    ("sig1" "Cheers,
 Robert" nil 3)
    ("sim" "simulation" nil 8)
    ("sims" "simulations" nil 41)
    ("smbh" "SMBH" nil 5)
    ("smt" "sometime" nil 0)
    ("spt" "SPT" nil 16)
    ("src" "source" nil 20)
    ...
    ("w" "with" nil 171)
    ("wi" "within" nil 7)
    ("wl" "weak lensing" nil 24)
    ("wmap" "WMAP" nil 1)
    ("wo" "without" nil 13)
    ("wrt" "with respect to" nil 8)
    ("xbcs" "XBCS" nil 3)
    ("xmm" "XMM-Newton" nil 28)
    ("xmm-bcs" "XMM-BCS" nil 0)
