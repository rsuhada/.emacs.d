...
(defface bm-persistent-face
  '((((class grayscale)
    ...
    (((class grayscale)
      (background dark))  (:background "LightGray"))
    (((class color)
      (background light)) (:foreground "White" :background "DarkOrange4"))
    (((class color)
      (background dark))  (:foreground "White" :background "DarkOrange4")))
...
(defface bm-fringe-persistent-face
  '((((class grayscale)
    ...
    (((class color)
      (background light)) (:foreground "White" :background "DarkOrange4"))
    (((class color)
      (background dark))  (:foreground "DarkOrange4" :background "DarkOrange4")))
