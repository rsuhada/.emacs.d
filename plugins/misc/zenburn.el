  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn
          `((background-color . ,zenburn-bg-1) ;; rs mod: zenburn-bg -> zenburn-bg-1
          ...
          '(ido-first-match ((t (:inherit zenburn-green)))) ;; rs mod: zenburn-primary-1
          ...
          `(mode-line-buffer-id ((t (:foreground ,zenburn-red-4 :weight bold)))) ;; rs mod: zenburn-yellow -> zenburn-red-4
